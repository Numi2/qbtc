...
public:
    CMainParams() {
        ...
        // SegWit v0 scripts: active at genesis (or disabled by setting -1)
...
public:
    CTestNetParams() {
        ...
        // CSV (BIP68/112/113): active at genesis
        consensus.CSVHeight = 0;
        // SegWit v0: active at genesis
        consensus.SegwitHeight = 0;
        // Post-quantum PQv1: active at genesis
        consensus.PQHeight = 0;
        // No BIP9 warning window on a fresh network
        consensus.MinBIP9WarningHeight = 0;
        consensus.powLimit = uint256{"00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff"};
