...
// Tagged Blake3 writers for Taproot sighash (replacing SHA256d-based HashWriter)
extern const Blake3Writer HASHER_BLAKE3_TAPSIGHASH; //!< Blake3Writer with tag "TapSighash"
extern const Blake3Writer HASHER_BLAKE3_TAPLEAF;    //!< Blake3Writer with tag "TapLeaf"
extern const Blake3Writer HASHER_BLAKE3_TAPBRANCH;  //!< Blake3Writer with tag "TapBranch"
...
// Definitions for Blake3 tagged hash writers
const Blake3Writer HASHER_BLAKE3_TAPSIGHASH("TapSighash");
const Blake3Writer HASHER_BLAKE3_TAPLEAF("TapLeaf");
const Blake3Writer HASHER_BLAKE3_TAPBRANCH("TapBranch");
// End Blake3 tagged hash writers
