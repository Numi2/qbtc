...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure   copyright is not removed by accident
    if (copyright_devs.find(" ") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The   developers";
    }
...
std::string LicenseInfo()
{
    ...
    return CopyrightHolders(strprintf(_("  %i-%i"), 2009, COPYRIGHT_YEAR).translated + " ") + "\n" +
           "\n" +
           ...
           strprintf(_("    file %s or %s"), "COPYING", "<https://opensource.org/licenses/MIT>").translated +
           "\n";
}
