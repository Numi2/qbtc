...
#include <algorithm>
#include <attributes.h> // Added for  
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for  
#include <util/string.h> // Added for  
...
// Added for  . Similar to std::runtime_format from C++26.
...
// Added for  . Wrapper for checking format strings at compile time.
